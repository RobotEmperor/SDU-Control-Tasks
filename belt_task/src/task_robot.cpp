...
void TaskRobot::estimation_of_belt_position()
{
	...
	static rw::math::Transform3D<> tf_bearing_to_static_robot;
	static rw::math::Transform3D<> tf_bearing_to_rubber_point;
	static rw::math::Transform3D<> tf_bearing_to_moveable_robot_start;
	static rw::math::Transform3D<> tf_bearing_to_moveable_robot;
	static rw::math::Transform3D<> distance_tf_static_robot_to_moveable_robot;
	static rw::math::Transform3D<> distance_tf_static_robot_to_moveable_robot_start;
	static rw::math::Transform3D<> tf_static_robot_to_bearing;
	static rw::math::Transform3D<> tf_static_robot_to_rubber_point;
	static rw::math::Transform3D<> tf_moveable_robot_to_bearing;
	static rw::math::Transform3D<> tf_bearing_to_error;
	static rw::math::Transform3D<> tf_moveable_robot_to_error;

	static rw::math::Transform3D<> temp;
	static rw::math::Vector3D<> init_current_belt_;
	static rw::math::Vector3D<> current_belt_;
	static rw::math::Vector3D<> desired_belt_;
	static rw::math::Vector3D<> error_;

	static rw::math::Transform3D<> tf_bearing_current_belt_;
	static rw::math::Transform3D<> tf_bearing_desired_belt_;

	static rw::math::Transform3D<> tf_tcp_current_belt_;
	static rw::math::Transform3D<> tf_tcp_desired_belt_;
	...
	if(!flag)
	{
		...
		desired_belt_[0] = 0;
		desired_belt_[1] = 0.03; // radious
		desired_belt_[2] = -0.018;
	...
	temp_tf_rotation = Transform3D<> (Vector3D<>(0, 0, 0), RPY<>(theta_z, theta_y, 0).toRotation3D());
	...
	tf_bearing_current_belt_.P() = current_belt_;
	...
	tf_moveable_robot_to_error = Transform3D<> (Vector3D<>(change_x_, change_y_, change_z_), RPY<>(0,0,0).toRotation3D());

	tf_moveable_robot_to_error = tf_current_*tf_moveable_robot_to_error;

	change_x_ = (tf_moveable_robot_to_error.P() - tf_current_.P())[0];
	change_y_ = (tf_moveable_robot_to_error.P() - tf_current_.P())[1];
	change_z_ = (tf_moveable_robot_to_error.P() - tf_current_.P())[2];




	//	current_belt_x_ = current_belt_[0];
	//	current_belt_y_ = current_belt_[1];
	//	current_belt_z_ = current_belt_[2];
	//
...
bool TaskRobot::hybrid_controller()
{
	...
	if(!robot_name_.compare("robot_B"))
	{
//		desired_pose_vector_[0] = desired_pose_vector_[0] + change_x_;
//		desired_pose_vector_[1] = desired_pose_vector_[1] + change_y_;
//		desired_pose_vector_[2] = desired_pose_vector_[2] + change_z_;
	}
	...
	else
	{
		...
		position_x_controller_->PID_calculate(desired_pose_vector_[0] + change_x_, compensated_pose_vector_[0], 0);
		position_y_controller_->PID_calculate(desired_pose_vector_[1] + change_y_, compensated_pose_vector_[1], 0);
		position_z_controller_->PID_calculate(desired_pose_vector_[2] + change_z_, compensated_pose_vector_[2], 0);
